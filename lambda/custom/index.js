...
const QUESTIONS = require('./data.js').questions
...
function askQuestion(handlerInput, welcome) {
	...
	var speakOutput = 'Would you rather, a:, ' + currentQuestion.choiceA + ', or, b:, ' + currentQuestion.choiceB + '?'
...
const ChoiceAIntentHandler = {
	canHandle(handlerInput) {
		return (
			Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest' &&
			Alexa.getIntentName(handlerInput.requestEnvelope) === 'ChoiceAIntent'
		)
	},
	handle(handlerInput) {
		const speakOutput =
...
const ChoiceBIntentHandler = {
	canHandle(handlerInput) {
		return (
			Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest' &&
			Alexa.getIntentName(handlerInput.requestEnvelope) === 'ChoiceBIntent'
		)
	},
	handle(handlerInput) {
		const speakOutput =
...
const IntentReflectorHandler = {
	...
	handle(handlerInput) {
		...
		const speakOutput = 'You called ' + intentName
